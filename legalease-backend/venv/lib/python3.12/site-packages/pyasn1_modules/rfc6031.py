...
id_pskc_devicestart_date = _OID(id_pskc, 6)

class at_pskc_devicestart_date(useful.GeneralizedTime):
    pass
...
id_pskc_keystart_date = _OID(id_pskc, 21)

class at_pskc_keystart_date(useful.GeneralizedTime):
    pass
...
sKeyPkgAttributesMap = {
     ...
     id_pskc_devicestart_date: at_pskc_devicestart_date(),
...
sKeyAttributesMap = {
     ...
     id_pskc_keystart_date: at_pskc_keystart_date(),
